...
class LossFunc:
    def __init__(self, device):
        ...
        (This can be achieved by assigning a positive class weight when creating the loss function object; refer to the official documentation for further details.)
